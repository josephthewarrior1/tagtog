  ...
  return (
    <section id="platform" className="relative overflow-hidden bg-[var(--color-bg-dark)] text-[var(--color-text-on-dark)]">
      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        >
          <p className="mb-6 font-mono text-[11px] uppercase tracking-[0.28em] text-white/52 sm:text-xs">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            <a
              href="#resources"
              className="inline-flex h-14 items-center justify-center rounded-sm bg-[var(--color-primary)] px-8 font-mono text-sm uppercase tracking-[0.12em] text-white transition hover:-translate-y-0.5 hover:bg-[var(--color-primary-hover)]"
            >
              See How It Works
            </a>
            <a
              href="#contact"
              className="inline-flex h-14 items-center justify-center border border-white/44 px-8 font-mono text-sm uppercase tracking-[0.12em] text-white transition hover:-translate-y-0.5 hover:border-white hover:bg-white/8"
            >
              Book a Demo
            </a>
          </div>
